...
<!-- generated with COPASI 4.40 (Build 278) (http://www.copasi.org) at 2023-11-16T11:49:48Z -->
...
<rdf:Description rdf:about="#ModelParameterSet_0">
    ...
    <InitialState type="initialState">
      0 0 6.02214076e+19 0 6.02214076e+17 0 0 0 0 0 0 1 1 1 10 10 190 0 130 105 100 10.5 10 0 10 0 10 10 0 10 0 0 0 16 160 16 130 100 10 50 100 10 10 500 10 100 100 500 10 1.1000000000000001 10 10 10 21.300000000000001 889 100 10 10 0 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=New Model,Vector=Values[KmNMN],Reference=InitialValue"/>
    ...
    <Task key="Task_16" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=New Model,Vector=Compartments[Peroxisome],Vector=Metabolites[PAR],Reference=Concentration>-0.6
        </ParameterText>
