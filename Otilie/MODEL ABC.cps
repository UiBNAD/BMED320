...
<!-- generated with COPASI 4.40 (Build 278) (http://www.copasi.org) at 2023-11-01T12:55:12Z -->
...
<rdf:Description rdf:about="#Compartment_1">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_3" name="A" simulationType="reactions" compartment="Compartment_1" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#Metabolite_5">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_1" name="V_in" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelValue_1">
      ...
      <ModelValue key="ModelValue_9" name="k1_f" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelValue_9">
      ...
      <ModelValue key="ModelValue_10" name="k1_b" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_12">
      ...
      <ModelValue key="ModelValue_13" name="v4" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_14">
      ...
      <ModelValue key="ModelValue_15" name="v6" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_16">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_1" name="v_influx" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_1">
        ...
        <ListOfConstants>
          <Constant key="Parameter_190" name="v" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_9" name="v1_f" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_9">
        ...
        <ListOfConstants>
          <Constant key="Parameter_187" name="k1" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_10" name="v1_b" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_10">
      ...
      <Reaction key="Reaction_11" name="v2" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_11">
        ...
        <ListOfConstants>
          <Constant key="Parameter_124" name="k1" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ABC model,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_12" name="v3" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_12">
      ...
      <Reaction key="Reaction_13" name="v4" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_13">
        ...
        <ListOfConstants>
          <Constant key="Parameter_121" name="v" value="3.5"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=ABC model,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_14" name="v5" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_14">
      ...
      <Reaction key="Reaction_15" name="v6" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_15">
        ...
        <ListOfConstants>
          <Constant key="Parameter_120" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=ABC model,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_16" name="v7" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_16">
        ...
        <ListOfConstants>
          <Constant key="Parameter_193" name="k1" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ABC model,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=ABC model,Vector=Values[k1_b]" value="0" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=ABC model,Vector=Values[v4]" value="3.5" type="ModelValue" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=ABC model,Vector=Reactions[v1_f]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ABC model,Vector=Reactions[v1_f],ParameterGroup=Parameters,Parameter=k1" value="0.10000000000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ABC model,Vector=Reactions[v1_b]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ABC model,Vector=Reactions[v1_b],ParameterGroup=Parameters,Parameter=k1" value="0" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=ABC model,Vector=Values[k1_b],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ABC model,Vector=Reactions[v2]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ABC model,Vector=Reactions[v2],ParameterGroup=Parameters,Parameter=k1" value="0.10000000000000001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=ABC model,Vector=Values[k2],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          ...
          <ModelParameterGroup cn="CN=Root,Model=ABC model,Vector=Reactions[v4]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ABC model,Vector=Reactions[v4],ParameterGroup=Parameters,Parameter=v" value="3.5" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 0 0 0 1 0.10000000000000001 0.10000000000000001 0 0.10000000000000001 0.10000000000000001 3.5 0.10000000000000001 0.10000000000000001 0.10000000000000001 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="Reaction Fluxes" type="Plot2D" active="0" taskTypes="">
      ...
      <Parameter name="plot engine" type="string" value="QCustomPlot"/>
      <ListOfPlotItems>
        <PlotItem name="(v_influx).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v_influx],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="(v1_f).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v1_f],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="(v1_b).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v1_b],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="(v2).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v2],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="(v3).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v3],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="(v4).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v4],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="(v5).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v5],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="(v6).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v6],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="(v7).Flux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Reactions[v7],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    ...
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values 3" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <Parameter name="plot engine" type="string" value="QCustomPlot"/>
      <ListOfPlotItems>
    ...
    <PlotSpecification name="Scan of Concentrations, Volumes, and Global Quantity Values 1" type="Plot2D" active="1" taskTypes="Scan">
      ...
      <ListOfPlotItems>
        <PlotItem name="[A]" type="Curve2D">
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Values[k1_b],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=ABC model,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[B]" type="Curve2D">
  ...
  <SBMLReference file="MODEL ABC.xml">
    ...
    <SBMLMap SBMLid="V_in" COPASIkey="ModelValue_1"/>
    <SBMLMap SBMLid="compartment" COPASIkey="Compartment_1"/>
    <SBMLMap SBMLid="k1_b" COPASIkey="ModelValue_10"/>
    <SBMLMap SBMLid="k1_f" COPASIkey="ModelValue_9"/>
    ...
    <SBMLMap SBMLid="v1_b" COPASIkey="Reaction_10"/>
    <SBMLMap SBMLid="v1_f" COPASIkey="Reaction_9"/>
    <SBMLMap SBMLid="v2" COPASIkey="Reaction_11"/>
    <SBMLMap SBMLid="v3" COPASIkey="Reaction_12"/>
    <SBMLMap SBMLid="v4" COPASIkey="ModelValue_13"/>
    <SBMLMap SBMLid="v4_0" COPASIkey="Reaction_13"/>
    <SBMLMap SBMLid="v5" COPASIkey="Reaction_14"/>
    <SBMLMap SBMLid="v6" COPASIkey="ModelValue_15"/>
    <SBMLMap SBMLid="v6_0" COPASIkey="Reaction_15"/>
    <SBMLMap SBMLid="v7" COPASIkey="Reaction_16"/>
    <SBMLMap SBMLid="v_influx" COPASIkey="Reaction_1"/>
  </SBMLReference>
